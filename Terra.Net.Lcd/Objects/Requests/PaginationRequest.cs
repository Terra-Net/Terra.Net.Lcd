...
namespace Terra.Net.Lcd.Objects.Requests
{
    public class PaginationRequest : BasePaginationRequest
    {
        ...
        /// </summary>
        [JsonProperty("pagination.offset")] 
        ...
        /// <inheritdoc />
        [JsonProperty("pagination.limit")]
        public override ulong? Limit { get; set; }
        ...
        /// </summary>
        [JsonProperty("pagination.count_total")]
        public bool? CountTotal { get; set; }

        /// <summary>
        /// reverse is set to true if results are to be returned in the descending order.
        /// </summary>
        [JsonProperty("pagination.reverse")]
